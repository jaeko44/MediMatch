  ...
  public async Task Seed () {
      if (!_context.MedicalProfessional.Any ()) {
        ...
        List<Facility> _facilityList = new List<Facility> {
          ...
          new Facility () {//39
            FacilityName = "Auburn Health Care Centre",
            Location = new Address () {
            StreetNo = "4A",
            Street = "Auburn ROAD",
            Suburb = "AUBURN",
          ...
          new Facility () {//40
            FacilityName = "ARNCLIFFE FAMILY HEALTH CLINIC",
            Location = new Address () {
            StreetNo = "1-3",
            Street = "Queen STREET",
            Suburb = "ARNCLIFFE",
            ...
            new Facility () {//41
            FacilityName = "Chapel Road Medical Centre",
            Location = new Address () {
            StreetNo = "293",
            Street = "Chapel ROAD",
            Suburb = "BANKSTOWN",
            ...
            new Facility () {//42
            FacilityName = "Greenfield Parade Family Practice",
            Location = new Address () {
            StreetNo = "Unit 4, 18",
            Street = "Greenfield PARADE",
            Suburb = "BANKSTOWN",
            State = "NSW",
            PostCode = "2200"
            }
            ...
            new Facility () {//43
            FacilityName = "Vinh Binh Medical Centre",
            Location = new Address () {
            StreetNo = "310",
            Street = "Chapel ROAD",
            Suburb = "BANKSTOWN",
            ...
            new Facility () {//44
            FacilityName = "Russell Street Medical Centre",
            Location = new Address () {
            StreetNo = "116-118",
        ...
        List<MedicalProfessional> _medicalProfessionaList = new List<MedicalProfessional> {
            ...
            new MedicalProfessional () {
            FirstMidName = "Tracey Grace",
            LastName = "Axisa",
            Service = _serviceList[4],
            Facility = new Facility () {
            FacilityName = "Malvern Road Medical Centre",
            Location = new Address () {
            StreetNo = "20",
            Street = "Malvern ROAD",
            Suburb = "GLENWOOD",
            ...
            PhoneNumber = "02 9836 3628",
            Email = "malvern20@bigpond.com",
            HoursActive = new List<HoursActive> {
            new HoursActive () {
            WeekDays = "Monday",
            Hours = "9am - 6pm"
            ...
            Facility = new Facility () {
            FacilityName = "Family Health and Wellness Centre",
            Location = new Address () {
            StreetNo = "Suite 15, Level 2, 10",
            Street = "Bradford CLOSE",
            Suburb = "KOTARA",
            State = "NSW",
            PostCode = "2289"
            }
            },
            PhoneNumber = "02 4956 3353",
            HoursActive = new List<HoursActive> {
            new HoursActive () {
            WeekDays = "Monday",
            Hours = "9am - 5pm"
            ...
            new MedicalProfessional () {
            FirstMidName = "Eleanor Irene",
            LastName = "Babcock",
            Service = _serviceList[0],
            Facility = new Facility () {
            FacilityName = "Pro-fit Physiotherapy and Allied Health Centre",
            Location = new Address () {
            StreetNo = "7",
            Street = "Revesby PLACE",
            Suburb = "REVESBY",
            State = "NSW",
            PostCode = "2212"
            }
            },
            PhoneNumber = "02 9771 1977",
            Email = "admin@pro-fitphysio.com.au",
            HoursActive = new List<HoursActive> {
            new HoursActive () {
            WeekDays = "Monday",
            Hours = "8am - 7pm"
            ...
            new MedicalProfessional () {
            FirstMidName = "Kathleen Mary",
            LastName = "Beale",
            Service = _serviceList[0],
            Facility = new Facility () {
            FacilityName = "JCU Health General Practice",
            Location = new Address () {
            StreetNo = "Level 1, 1",
            ...
            new MedicalProfessional () {
            FirstMidName = "Carolyn Margaret",
            LastName = "Avery",
            Service = _serviceList[3],
            Facility = new Facility () {
            FacilityName = "St George Family Medical Centre",
            Location = new Address () {
            StreetNo = "23",
            Street = "Best STREET",
            Suburb = "WAGGA WAGGA",
            ...
            PhoneNumber = "02 6971 9009",
            Email = "info@stgeorgemed.com.au",
            HoursActive = new List<HoursActive> {
            new HoursActive () {
            WeekDays = "Monday",
            Hours = "8:30am - 5pm"
            ...
            Facility = new Facility () {
            FacilityName = "Northwest Health - Tamwell",
            Location = new Address () {
            StreetNo = "Level 1, Tamwell Building, 121",
            Street = "Johnston STREET",
            Suburb = "TAMWORTH",
            State = "NSW",
            PostCode = "2340"
            }
            },
            PhoneNumber = "02 6768 3222",
            HoursActive = new List<HoursActive> {
            new HoursActive () {
            WeekDays = "Monday",
            Hours = "8:30am - 5:30pm"
            ...
            new MedicalProfessional () {
            FirstMidName = "Miranneil",
            LastName = "Azarcon",
            Service = _serviceList[1],
            Facility = _facilityList[40],
            PhoneNumber = "02 9597 3366",
            HoursActive = new List<HoursActive> {
            new HoursActive () {
            WeekDays = "Monday",
            Hours = "7:30am - 9pm"
            ...
            Service = _serviceList[0],
            Facility = new Facility () {
            FacilityName = "Ashfield Country Practice",
            Location = new Address () {
            StreetNo = "279",
            Street = "Ashfield ROAD",
            Suburb = "WINDERMERE",
            State = "NSW",
            PostCode = "4670"
            }
            },
            PhoneNumber = "07 4159 3159",
            Email = "admin@ashfieldcountrypractice.com.au",
            HoursActive = new List<HoursActive> {
            new HoursActive () {
            WeekDays = "Monday",
            Hours = "8:30am - 5pm"
            ...
            Service = _serviceList[0],
            Facility = new Facility () {
            FacilityName = "N A S Advanced Medical Centre Auburn",
            Location = new Address () {
            StreetNo = "79",
            Street = "Auburn ROAD",
            Suburb = "AUBURN",
            ...
            PhoneNumber = "02 9649 6027",
            Email = "nas.advanced@gmail.com",
            HoursActive = new List<HoursActive> {
            new HoursActive () {
            WeekDays = "Sunday",
            Hours = "8am - 10:30pm"
            ...
            new MedicalProfessional () {
            FirstMidName = "Sione Kafoa",
            LastName = "Akauola",
            Service = _serviceList[0],
            Facility = _facilityList[39],
            PhoneNumber = "02 9643 3800",
            HoursActive = new List<HoursActive> {
              new HoursActive () {
            WeekDays = "Sunday",
            Hours = "9am - 7:30pm"
            ...
            new MedicalProfessional () {
            FirstMidName = "Muhamad Al",
            LastName = "Saidy",
            Service = _serviceList[2],
            Facility = _facilityList[39],
            PhoneNumber = "02 9643 2389",
            HoursActive = new List<HoursActive> {
            new HoursActive () {
            WeekDays = "Monday",
            Hours = "9am - 6pm"
            ...
            new MedicalProfessional () {
            FirstMidName = "Bin Akbar",
            LastName = "Ali",
            Service = _serviceList[0],
            Facility = _facilityList[41],
            PhoneNumber = "02 9796 4114",
            Email = "chapelmedicalcentre@yahoo.com.au",
            HoursActive = new List<HoursActive> {
            new HoursActive () {
            WeekDays = "Monday",
            Hours = "9am - 6pm"
            ...
            new MedicalProfessional () {
            FirstMidName = "Mohammad Abdul",
            LastName = "Awal",
            Service = _serviceList[0],
            Facility = _facilityList[42],
            PhoneNumber = "02 9709 5544",
            HoursActive = new List<HoursActive> {
            new HoursActive () {
            WeekDays = "Monday",
            Hours = "9am - 5:30pm"
            ...
            new MedicalProfessional () {
            FirstMidName = "Omar Mohamad",
            LastName = "Ajaj",
            Service = _serviceList[6],
            Facility = _facilityList[43],
            PhoneNumber = "02 9796 7545",
            HoursActive = new List<HoursActive> {
            new HoursActive () {
            WeekDays = "Sunday",
            Hours = "9am - midday"
...
new MedicalProfessional () {
            ...
            Service = _serviceList[0],
            Facility = new Facility () {
            FacilityName = "Centre Health Complex - Shellharbour",
            Location = new Address () {
            StreetNo = "Suite 5, 9",
            Street = "Captain Cook DRIVE",
            Suburb = "BARRACK HEIGHTS",
            State = "NSW",
            PostCode = "2528"
            }
            },
            PhoneNumber = "02 4295 9999",
            Email = "sangi@centrehealth.com.au",
            HoursActive = new List<HoursActive> {
            new HoursActive () {
            WeekDays = "Sunday",
            Hours = "8am - 8pm"
...
new MedicalProfessional () {
            FirstMidName = "Mounir Gaballa",
            LastName = "Abadir",
            Service = _serviceList[0],
            Facility = new Facility () {
            FacilityName = "Bateau Bay Medical Centre",
            Location = new Address () {
            StreetNo = "599",
            Street = "The Entrance ROAD",
            Suburb = "BATEAU BAY",
            State = "NSW",
            PostCode = "2261"
            }
            },
            PhoneNumber = "02 4332 6411",
            Email = "fiona@bbmc.com.au",
            HoursActive = new List<HoursActive> {
            new HoursActive () {
            WeekDays = "Monday",
            Hours = "8:30am - 6pm"
            ...
            new MedicalProfessional () {
            FirstMidName = "Lauren Jane",
            LastName = "Beacroft",
            Service = _serviceList[3],
            Facility = _facilityList[44],
            PhoneNumber = "02 6331 2266",
            HoursActive = new List<HoursActive> {
            new HoursActive () {
            WeekDays = "Monday",
            Hours = "8:30am - 6pm"
            ...
            new MedicalProfessional () {
            FirstMidName = "Enrique",
            LastName = "Avedillo",
            Service = _serviceList[0],
            Facility = _facilityList[45],
            PhoneNumber = "02 9037 9287",
            HoursActive = new List<HoursActive> {
            new HoursActive () {
            WeekDays = "Monday",
            Hours = "9am - 5pm"
            ...
            new MedicalProfessional () {
            FirstMidName = "Soudabeh",
            LastName = "Akbari",
            Service = _serviceList[5],
            Facility = new Facility () {
            FacilityName = "Beecroft Medical Centre",
            Location = new Address () {
            StreetNo = "Shop 1, 97-99",
            ...
            PhoneNumber = "02 9484 0033",

            Email = "admin@beecroftmedical.com.au",
            HoursActive = new List<HoursActive> {
            new HoursActive () {
            WeekDays = "Sunday",
            Hours = "9am - 4pm"
            ...
            new MedicalProfessional () {
            FirstMidName = "Eunice Boakye",
            LastName = "Dankwa",
            Service = _serviceList[5],
            Facility = new Facility () {
            FacilityName = "Canning Street Surgery",
            Location = new Address () {
            StreetNo = "22",
