...
namespace MediMatchRMIT.Data
{
    public class ApplicationDbContext : IdentityDbContext<ApplicationUser>
    {
        ...
        {
            optionsBuilder.UseSqlite("Data Source=medimatch-v1.1.db");
        }
    }
...
public class DesignTimeDbContextFactory : IDesignTimeDbContextFactory<ApplicationDbContext>
{
    public ApplicationDbContext CreateDbContext(string[] args)
    {
        ...
        builder.UseSqlite("Data Source=medimatch-v1.1.db");
...
public class SeedData
{
    ...
    public async Task Seed()
    {
        if (!_context.MedicalProfessional.Any())
        {
            ...
            Debug.WriteLine("This can take a while, we will start loading the coordinates of each facility and enter all the records into the DB (Happens once per seed)");
